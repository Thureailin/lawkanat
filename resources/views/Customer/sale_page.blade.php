                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @foreach($table_lists as $table)
                                            <tr>
                                                ...
                                                <td><a href="{{route('customer_order_sale', $table->id)}}" class="btn btn-outline-primary">Go To Shop Order Page</a></td>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="m-l-10 align-self-center float-right">
                                                        <h4 class="m-b-1 font-lgiht" style="margin-top:30px;">Table Number -
                                                            ...
                                                            <div class="text-right">
                                                                ...
                                                                {!! QrCode::size(100)->generate("http://192.168.100.220:8000/Customer/Shop-Order/{$table->id}") !!}
                                                            </div>
                                                                                                           </div>
                                                </div>
                                            </div>
